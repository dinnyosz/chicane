...
class TestStepChannelDirs:
    def test_no_defaults_done_immediately(self):
        # base dir empty, immediately press done
        prompt_values = ["", "d"]
    ...
    def test_add_one_mapping(self):
        # base dir, then add a channel, then done
        prompt_values = [
    ...
    def test_existing_mappings_kept(self):
        ...
        # keep base dir, immediately done
...
class TestSetupCommand:
    ...
    def test_fresh_setup_writes_env(self, tmp_path, monkeypatch):
        ...
        # Prompt.ask: base dir, done (channel dirs), 3 optional settings
        prompt_values = ["", "d", "", "", ""]
    ...
    def test_existing_env_tokens_as_defaults(self, tmp_path, monkeypatch):
        ...
        # Prompt.ask: base dir (keep), done (channel dirs), 3 optional settings
        prompt_values = ["/old", "d", "", "", ""]
    ...
    def test_existing_env_values_overridden(self, tmp_path, monkeypatch):
        ...
        # Prompt.ask: base dir, add channel, name, path, done, 3 optional settings
        prompt_values = ["", "a", "new-proj", "new-proj", "a", "extra", "extra", "d", "", "", ""]
        # Confirm.ask: skip step1=True, debug=False
        confirm_values = [True, False]
